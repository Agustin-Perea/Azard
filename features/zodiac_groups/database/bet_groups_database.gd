extends Resource
class_name BetGroupItemDatabase

@export var pool_seed : int
@export var all_items: Array[BetGroupItemDefinition]
...
func calculate_total_weight()->void:
	...
	for item in all_items:
		if item is BetGroupItemDefinition: # Validación de tipo en tiempo de ejecución
...
func get_random_item() -> BetGroupItemDefinition:
