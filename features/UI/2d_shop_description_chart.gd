...
#data 
#target to follow
@export var passive_item_shop_element: Node3D

#name
@onready var buy_button : Button = get_node_or_null("Button")
@onready var item_name : Label = $Panel/Name
@onready var item_description : Label = $Panel/Desctiption
...
func change_passive_item_data(new_passive_item_shop_element: Node3D) -> void:
